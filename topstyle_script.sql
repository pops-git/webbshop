...
/****** Object:  Database [TopStyleDB]    Script Date: 4/24/2021 9:05:45 PM ******/
CREATE DATABASE [TopStyleDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TopStyleDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\TopStyleDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TopStyleDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\TopStyleDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
